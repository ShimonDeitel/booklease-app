...
struct ContentView: View {
    ...
    @State private var editingItem: BookleaseItem?
    ...
    private func row(for item: BookleaseItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: BookleaseItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
